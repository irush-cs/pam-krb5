...
=item prompt_first_pass

Like I<try_first_pass>, but use the password as the answer to the first prompt
question. Useful for arbitrary prompting from the kerberos (e.g. under some
FAST protocols).
